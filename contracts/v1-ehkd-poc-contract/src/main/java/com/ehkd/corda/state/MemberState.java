...
public class MemberState implements LinearState, QueryableState {
    ...
    public MemberState(String userId, String type, String industry, List<Party> parties,UniqueIdentifier linearId) {
        this.userId = userId;
        this.type = type;
    ...
    public PersistentState generateMappedObject(@NotNull MappedSchema schema) {
        if(schema instanceof MemberSchemaV1) {
            return new PersistentMember(userId,type,industry,linearId.getId());
        } else {
